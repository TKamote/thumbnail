...
const mc05 = () => {
  ...
  const totalItems = 2;
  const sum = [isChecked1, isChecked2, isChecked3, isChecked4].filter(
    (isChecked) => isChecked
  ).length;
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.text80text20}>
        <View style={styles.text80}>
          <Text style={styles.subtitle}>
            Are all affected personnel aware of the process including OEHS
            aspect?
          </Text>
        </View>
      ...
      <View style={styles.text80text20}>
        <View style={styles.text80}>
          <Text style={styles.subtitle}>
            Are Management Team Meetings conducted on a scheduled basis?
          </Text>
        </View>
