...
const hr02 = () => {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>HR 02 - STAFF MOVEMENT RECORD</Text>
      ...
      <View style={styles.text80text20}>
        <View style={styles.text80}>
          <Text style={styles.subtitle}>
            Does site manager conducts weekly checks on the time keeping
            records? Verify
          </Text>
        </View>
      ...
      <View style={styles.text80text20}>
        <View style={styles.text80}>
          <Text style={styles.subtitle}>
            Are appropriate action taken when necessary?
          </Text>
        </View>
