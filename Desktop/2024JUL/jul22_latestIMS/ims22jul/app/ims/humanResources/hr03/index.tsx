...
const hr03 = () => {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>HR 03 - DAY OFF & LEAVE MANAGEMENT</Text>
      ...
      <View style={styles.text80text20}>
        <View style={styles.text80}>
          <Text style={styles.subtitle}>
            Is a Day Off & Leave Planner available on site?
          </Text>
        </View>
      ...
      <View style={styles.text80text20}>
        <View style={styles.text80}>
          <Text style={styles.subtitle}>
            Is the Day Off & Leave Planner verified & updated regularly?
          </Text>
        </View>
      ...
      <View style={styles.text80text20}>
        <View style={styles.text80}>
          <Text style={styles.subtitle}>
            Is the Day Off & Leave Planner kept for references?
          </Text>
        </View>
      ...
      <View style={styles.text80text20}>
        <View style={styles.text80}>
          <Text style={styles.subtitle}>
            Is the Day Off & Leave Planner appropriately displayed for easy access? Notice Board
          </Text>
        </View>
      ...
      <View style={styles.text80text20}>
        <View style={styles.text80}>
          <Text style={styles.subtitle}>
            Are the duties covered when staff on off / leave? Review Roster
          </Text>
        </View>
