  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>FC 06 - FIXED ASSET</Text>
        ...
        <View style={styles.text80text20}>
          <View style={styles.text75}>
            <Text style={styles.subtitle}>
              The cost of asset, is it equal or more than $300?
            </Text>
          </View>
        ...
        <View style={styles.text80text20}>
          <View style={styles.text80}>
            <Text style={styles.subtitle}>
              For asset below $300, are they written off and recorded into the
        ...
        <View style={styles.text80text20}>
          <View style={styles.text80}>
            <Text style={styles.subtitle}>
              Payment voucher accompanied with the payment for Fixed Asset?
            </Text>
          </View>
        ...
        <View style={styles.text80text20}>
          <View style={styles.text80}>
            <Text style={styles.subtitle}>
              Are all the relevant items completed in the Fixed Asset Register?
            </Text>
          </View>
        ...
        <View style={styles.text80text20}>
          <View style={styles.text80}>
            <Text style={styles.subtitle}>
              Is the Fixed Asset Register filed into the Fixed Asset file?
            </Text>
          </View>
        ...
        <View style={styles.text80text20}>
          <View style={styles.text80}>
            <Text style={styles.subtitle}>
              Are all Fixed Assets labeled as per OMS-OC-04?
            </Text>
          </View>
        ...
        <View style={styles.text80text20}>
          <View style={styles.text80}>
            <Text style={styles.subtitle}>
              Is a journal raised to initiate the depreciation for fixed asset
              with the stated time frame of item?
            </Text>
          </View>
        ...
        <View style={styles.text80text20}>
          <View style={styles.text80}>
            <Text style={styles.subtitle}>
              Is a Fixed Asset Schedule attached to financial statement?
            </Text>
          </View>
        ...
        <View style={styles.text80text20}>
          <View style={styles.text80}>
            <Text style={styles.subtitle}>
              Are all items meant for disposal, approved by relevant authority?
            </Text>
          </View>
        ...
        <View style={styles.text80text20}>
          <View style={styles.text80}>
            <Text style={styles.subtitle}>
              Is the asset verification certificate dispatched to the site and
              verified by site manager? One-month before the financial year-end?
            </Text>
          </View>
