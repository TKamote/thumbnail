...
const admin01 = () => {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>AC 01 – FILING SYSTEM FOR SITE AND HEAD OFFICE</Text>
      ...
      <View style={styles.text80text20}>
        <View style={styles.text80}>
          <Text style={styles.subtitle}>
          Is the filing reference system appropriately set up? Review
          </Text>
        </View>
