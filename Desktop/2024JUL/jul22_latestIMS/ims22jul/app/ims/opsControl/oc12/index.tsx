  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>
        OC 12 – SERVICE PROVIDERS MOVEMENT RECORD
      </Text>
      ...
      <View style={styles.text80text20}>
        <View style={styles.text80}>
          <Text style={styles.subtitle}>
          Is Movement Record Book(s) maintained for all service providers?
          </Text>
        </View>
      ...
      <View style={styles.text80text20}>
        <View style={styles.text80}>
          <Text style={styles.subtitle}>
          Is it monitored periodically, but no less than weekly?
          </Text>
        </View>
      ...
      <View style={styles.text80text20}>
        <View style={styles.text80}>
          <Text style={styles.subtitle}>
          Are all contractor / visitors log into the logbook / movement record book?
          </Text>
        </View>
