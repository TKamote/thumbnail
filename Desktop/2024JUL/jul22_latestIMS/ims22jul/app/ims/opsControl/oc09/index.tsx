    ...
    <ScrollView>
      <View style={styles.container}>
        ...
        <View style={styles.text80text20}>
          <View style={styles.text80}>
            <Text style={styles.subtitle}>
              Are all affected personnel aware of the pre-qualification of
              vendor or tender process and in consultation with HQ PM.
            </Text>
          </View>
        ...
        <View style={styles.text80text20}>
          <View style={styles.text80}>
            <Text style={styles.subtitle}>
              Are the attendances of service provider regularly verified?
              (OMS-OC-12) Are checks for foreign worker identification process
              and record maintenance in less than on a weekly basis?
            </Text>
          </View>
        ...
        <View style={styles.text80text20}>
          <View style={styles.text80}>
            <Text style={styles.subtitle}>
              Are the following readily available on site?
            </Text>
          </View>
        ...
        <View style={styles.text80text20}>
          <View style={styles.text80}>
            <Text style={styles.subtitle}>a. Employee Schedules</Text>
          </View>
          <View style={styles.text20}>
            <Checkbox
              style={styles.checkbox}
        ...
        <View style={styles.text80text20}>
          <View style={styles.text80}>
            <Text style={styles.subtitle}>b. Periodic Cleaning Schedules</Text>
          </View>
          <View style={styles.text20}>
            <Checkbox
              style={styles.checkbox}
        ...
        <View style={styles.text80text20}>
          <View style={styles.text80}>
            <Text style={styles.subtitle}>c. Chemical List</Text>
          </View>
          <View style={styles.text20}>
            <Checkbox
              style={styles.checkbox}
        ...
        <View style={styles.text80text20}>
          <View style={styles.text80}>
            <Text style={styles.subtitle}>d. Equipment List</Text>
          </View>
          <View style={styles.text20}>
            <Checkbox
              style={styles.checkbox}
        ...
        <View style={styles.text80text20}>
          <View style={styles.text80}>
            <Text style={styles.subtitle}>e. Staffing List</Text>
          </View>
          <View style={styles.text20}>
            <Checkbox
              style={styles.checkbox}
        ...
        <View style={styles.text80text20}>
          <View style={styles.text80}>
            <Text style={styles.subtitle}>
              f. Insurance (Public Liability & WIC)
            </Text>
          </View>
          <View style={styles.text20}>
            <Checkbox
        ...
        <View style={styles.text80text20}>
          <View style={styles.text80}>
            <Text style={styles.subtitle}>g. Risk Assessment</Text>
          </View>
          <View style={styles.text20}>
            <Checkbox
              style={styles.checkbox}
        ...
        <View style={styles.text80text20}>
          <View style={styles.text80}>
            <Text style={styles.subtitle}>
              Is there a master/monthly inspection schedule?
            </Text>
          </View>
          <View style={styles.text20}>
            <Checkbox
        ...
        <View style={styles.text80text20}>
          <View style={styles.text80}>
            <Text style={styles.subtitle}>
              Is there a weekly inspection performed by the site manager? Verify
              record
            </Text>
          </View>
          <View style={styles.text20}>
        ...
        <View style={styles.text80text20}>
          <View style={styles.text80}>
            <Text style={styles.subtitle}>
              Are the inspection forms appropriately recorded, verified and
              filed?
            </Text>
          </View>
          <View style={styles.text20}>
        ...
        <View style={styles.text80text20}>
          <View style={styles.text80}>
            <Text style={styles.subtitle}>
              Are the corrective action recorded? Review process
            </Text>
          </View>
          <View style={styles.text20}>
            <Checkbox
        ...
        <View style={styles.text80text20}>
          <View style={styles.text80}>
            <Text style={styles.subtitle}>
              Are job completion form submitted by service provider? Check
              record
            </Text>
          </View>
          <View style={styles.text20}>
