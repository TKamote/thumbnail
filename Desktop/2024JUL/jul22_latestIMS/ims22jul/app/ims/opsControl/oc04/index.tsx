...
const oc04 = () => {
  ...
  return (
    ...
    <View style={styles.container}>
      <Text style={styles.title}>OC 04 – PROPERTY ASSET REGISTER</Text>
      ...
      <View style={styles.text80text20}>
        <View style={styles.text80}>
          <Text style={styles.subtitle}>
            Is there a Building Services/Property Asset Register, with all
            assets recorded?
          </Text>
        </View>
      ...
      <View style={styles.text80text20}>
        <View style={styles.text80}>
          <Text style={styles.subtitle}>
            Is a regular update performed for all the equipment? Review process
            for new equipment & change of equipment.
          </Text>
        </View>
      ...
      <View style={styles.text80text20}>
        <View style={styles.text80}>
          <Text style={styles.subtitle}>
            Are all the assets labeled and in accordance to the procedures?
          </Text>
        </View>
      ...
      <View style={styles.text80text20}>
        <View style={styles.text80}>
          <Text style={styles.subtitle}>
            Have the drawings/maintenance manuals been updated and reflected in
            filing index?
          </Text>
        </View>
      ...
      <View style={styles.text80text20}>
        <View style={styles.text80}>
          <Text style={styles.subtitle}>
            1. Electrical Installation - Updating of drawings by LEW
          </Text>
        </View>
      ...
      <View style={styles.text80text20}>
        <View style={styles.text80}>
          <Text style={styles.subtitle}>
            2. Operation Maintenance Manual (OMM)
          </Text>
        </View>
