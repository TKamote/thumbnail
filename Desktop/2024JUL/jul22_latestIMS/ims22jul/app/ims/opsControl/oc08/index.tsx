...
const oc08 = () => {
  ...
  const handleCheckbox15Change = (value: boolean) => {
    setChecked15(value);
    if (value) {
      setChecked16(false);
    }
  ...
  const handleCheckbox16Change = (value: boolean) => {
    setChecked16(value);
    if (value) {
      setChecked15(false);
    }
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.text80text20}>
        <View style={styles.text80}>
          <Text style={styles.subtitle}>1. CMO log-in</Text>
        </View>
      ...
      <View style={styles.text80text20}>
        <View style={styles.text80}>
          <Text style={styles.subtitle}>2. Incident report form</Text>
        </View>
      ...
      <View style={styles.text80text20}>
        <View style={styles.text80}>
          <Text style={styles.subtitle}>
            Are all incidents, positive or negative, recorded?
          </Text>
        </View>
      ...
      <View style={styles.text80text20}>
        <View style={styles.text80}>
          <Text style={styles.subtitle}>a. Management?</Text>
        </View>
      ...
      <View style={styles.text80text20}>
        <View style={styles.text80}>
          <Text style={styles.subtitle}>b. Security?</Text>
        </View>
      ...
      <View style={styles.text80text20}>
        <View style={styles.text80}>
          <Text style={styles.subtitle}>
            Are all incidents’ forms forwarded to the HQ Supervisor within 24
            hours?
          </Text>
        </View>
      ...
      <View style={styles.text80text20}>
        <View style={styles.text80}>
          <Text style={styles.subtitle}>
            Are all incidents’ forms appropriately administered? Uploaded at
            CMO?
          </Text>
        </View>
        ...
        <View style={styles.text20}>
          <Checkbox
            style={styles.checkbox}
            value={isChecked15}
            onValueChange={handleCheckbox15Change}
          />
          <Checkbox
            style={styles.checkbox}
            value={isChecked16}
            onValueChange={handleCheckbox16Change}
          />
        </View>
      </View>
