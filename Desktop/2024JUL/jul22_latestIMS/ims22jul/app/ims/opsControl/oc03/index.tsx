...
const oc03 = () => {
  ...
  // Does the site staff conduct Daily Routine Walkabout? Check schedule.
  // Is there a master/monthly schedule for regular inspection of building equipment / building facility?
  // Are all inspection forms verified by the appropriate authority? Filed
  // appropriately?
  // Are corrective actions performed on the defects? Check process and administration.
  // Are the assets detailed under OC 04 clearly specified in the Preventive Maintenance program? Review
  // Are daily inspections performed on all fire exit doors, signs and logged on the record?
  // Are the fire protection equipment registered in the Building Services Asset Register?
    ...
    <ScrollView>
      <View style={styles.container}>
        ...
        <View style={styles.text80text20}>
          <View style={styles.text80}>
            <Text style={styles.subtitle}>
              Does the site staff conduct Daily Routine Walkabout? Check
              schedule.
            </Text>
          </View>
        ...
        <View style={styles.text80text20}>
          <View style={styles.text80}>
            <Text style={styles.subtitle}>
              Is there a master/monthly schedule for regular inspection of
              building equipment / building facility?
            </Text>
          </View>
        ...
        <View style={styles.text80text20}>
          <View style={styles.text80}>
            <Text style={styles.subtitle}>
              Are all inspection forms verified by the appropriate authority?
              Filed appropriately?
            </Text>
          </View>
        ...
        <View style={styles.text80text20}>
          <View style={styles.text80}>
            <Text style={styles.subtitle}>
              Are corrective actions performed on the defects? Check process and
              administration.
            </Text>
          </View>
        ...
        <View style={styles.text80text20}>
          <View style={styles.text80}>
            <Text style={styles.subtitle}>
              Are the assets detailed under OC 04 clearly specified in the
        ...
        <View style={styles.text80text20}>
          <View style={styles.text80}>
            <Text style={styles.subtitle}>
              Are daily inspections performed on all fire exit doors, signs and
        ...
        <View style={styles.text80text20}>
          <View style={styles.text80}>
            <Text style={styles.subtitle}>
              Are the fire protection equipment registered in the Building
